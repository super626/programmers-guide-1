...
* to create a `TerrainData` varaiable with detailsMaps, you need to specify the terrain's heightMap file path and alphaMap file path:
...
The following code snippet is creating a player and making it moving around in the terrain:
